 ...
 * All credit goes to Dr. Kobilarov. Some of his documentation
 * comments are transcribed below for clarity.
 *
 * Summary: This computes second-order numerical optimal control.
 * The code computes the optimal control adjustment for a given
 * dynamical system.
 *
 * In his implementation, second-order terms in the dynamics are
